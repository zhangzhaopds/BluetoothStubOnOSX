...
//MARK:- static parameter
    ...
    func publishService(){
        ...
        let description1 = CBMutableDescriptor(type: descriptionStringType, value: "外设值1——canNotifyCharacteristic")
        let description2 = CBMutableDescriptor(type: descriptionStringType, value: "外设值2——canReadCharacteristic")
        let description3 = CBMutableDescriptor(type: descriptionStringType, value: "外设值3——canWriteAndWirteCharacteristic")
